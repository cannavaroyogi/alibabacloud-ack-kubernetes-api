...
export default class Downsize {
  ...
  static async main(args: string[]): Promise<void> {
    ...
    let client = Downsize.createClient(process.env['ALIBABA_CLOUD_ACCESS_KEY_ID'], process.env['ALIBABA_CLOUD_ACCESS_KEY_SECRET']);
...
Downsize.main(process.argv.slice(2));